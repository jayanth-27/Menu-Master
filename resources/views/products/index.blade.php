            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <div>
                    <button type="button" class="btn btn-primary mb-3"><a href="./products/create" style="text-decoration:none; color:white; margin-bottom:2%">ADD NEW MENU ITEM</a></button>
                </div>
                @if (count($products)>=1)
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{!!Form::open(['action'=> ['App\Http\Controllers\ProductController@destroy', $product->id], 'method' =>'POST', 'class' =>'pull-right'])!!}
